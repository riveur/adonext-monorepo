  ...
  "fixed left-[50%] top-[50%] z-50 grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 border bg-background p-6 shadow-lg duration-200 sm:rounded-lg",
  {
    variants: {
      animation: {
        ...
        'right-to-left': "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:slide-out-to-right-[100%] data-[state=open]:slide-in-from-right-[100%] sm:rounded-none border-y-0"
      }
    },
    defaultVariants: {
      animation: "default",
